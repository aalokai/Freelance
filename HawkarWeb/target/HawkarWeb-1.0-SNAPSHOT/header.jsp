<%-- 
    Document   : header
    Created on : Sep 27, 2023, 11:24:06 AM
    Author     : aalok
--%>
...
<div class="row text-light" style="background-color: #1142f5;">
...
<div class="row" style="min-height: 50px;">
    <nav class="navbar navbar-expand-lg " style="background-color: #59bdf7;">
  <div class="container-fluid ">
    <a class="navbar-brand fw-bold text-light" href="#">HAWKAR</a>
    ...
    <div class="collapse navbar-collapse fw-bold" id="navbarNavAltMarkup">
      <div class="navbar-nav ">
        ...
        <a class="nav-link text-light" href="career.jsp">Career</a>
